...
The project uses GitHub Actions for CI. The workflow file is located at '.github/workflows/flutter_ci.yml'. It runs on every pull request to the main and development branches (Sprint)
